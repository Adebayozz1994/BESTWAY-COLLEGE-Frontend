...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-gradient-to-r from-yellow-400 to-green-500 text-white flex justify-between items-center lg:px-10 lg:py-7 fixed top-0 w-screen z-50 p-2">
  <div>
    <Link to="/home">
    <h1 className=" text-4xl font-bold text-white">BESTWAY COLLEGE</h1>
